...
public class CategoryController {
    ...
    public ResponseEntity<Category> addCategory(@RequestBody CategoryDto categoryDto) throws CategoryDetailAlreadyExistsException {
        Category category = categoryService.persistCategory(new Category(categoryDto));
        return new ResponseEntity<>(category, HttpStatus.CREATED);
    }

    @PutMapping(value = "/update")
    public ResponseEntity<Category> updateCategory(@RequestBody CategoryDto categoryDto) throws CategoryDetailDoesNotExistsException {
        Category category = categoryService.updateCategory(new Category(categoryDto));
        return new ResponseEntity<>(category, HttpStatus.CREATED);
    }

    @DeleteMapping(value = "/delete")
    public ResponseEntity<CategoryDto> deleteCategory(@RequestParam String name) throws CategoryDetailDoesNotExistsException {
